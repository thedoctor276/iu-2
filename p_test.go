...
func TestTestPSetDataContext(t *testing.T) {
	testComponentSetDataContext(t, pTest())
}

func TestPInit(t *testing.T) {
	testComponentInit(t, pTest())
}

func TestPClose(t *testing.T) {
	testComponentClose(t, pTest())
}

func TestPRender(t *testing.T) {
	testComponentRender(t, pTest())
}

func TestPSync(t *testing.T) {
	testComponentSync(t, pTest())
}
