...
func (comp *Div) Tag() string {
	return "div"
}

func (comp *Div) SetDataContext(dataCtx interface{}) {
	comp.dataContext = dataCtx
	comp.NotifyDataContextChanged()
}

func (comp *Div) NotifyDataContextChanged() {
...
func (comp *Div) Init(view View, parent Component) {
