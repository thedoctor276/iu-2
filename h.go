...
func (comp *H) Tag() string {
	return fmt.Sprintf("h%v", comp.Level)
}

func (comp *H) SetDataContext(dataCtx interface{}) {
	comp.dataContext = dataCtx
	comp.NotifyDataContextChanged()
}

func (comp *H) NotifyDataContextChanged() {
